...
| --- | --- | --- | --- |
| `pytest --tier=portable` | 827 | varies | Changing packaging, dependencies, or the Python floor. This is what `tox` runs on 3.10-3.12. |
| `pytest --tier=quick` | 2313 | varies | Default while editing. |
...
| `pytest --tier=full` | 2353 | varies | Before pushing. Everything that runs without a board, the acquisition tier included. |
