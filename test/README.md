...
| `pytest --tier=quick` | 1107 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1126 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
