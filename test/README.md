...
| `pytest --tier=quick` | 1145 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1164 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
