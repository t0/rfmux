...
| `pytest --tier=quick` | 1099 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1118 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
