...
| `pytest --tier=quick` | 1047 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1069 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
| `pytest --tier=hardware --serial 0024` | 75 | needs a board | Against a connected board; see *Hardware tests*. |
| `pytest --tier=all --serial 0024` | 1144 | needs a board | Before a release. |
