...
```bash
pytest --tier=quick                 # Edit loop: 1699 tests, ~7 min
pytest --tier=portable              # No CRS, no GUI: 652 tests, ~9 s
pytest --tier=full                  # All 1735 that run without a board, including demos
