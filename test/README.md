...
| `pytest --tier=quick` | 845 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 865 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
