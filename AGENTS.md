...
```bash
pytest --tier=quick                 # Edit loop: 1723 tests, ~7 min
pytest --tier=portable              # No CRS, no GUI: 658 tests, ~9 s
pytest --tier=full                  # All 1759 that run without a board, including demos
