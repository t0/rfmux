...
to sample the resonance dips. Here, 60,000 points across 450 MHz give about
7.5 kHz spacing.
...
Measure the same band with 5,000 points instead of 60,000: about 90 kHz spacing
instead of 7.5 kHz. Keep the search thresholds unchanged so we can compare the
