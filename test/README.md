...
| `pytest --tier=quick` | 1271 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1294 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
