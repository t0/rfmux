...
| `pytest --tier=quick` | 1277 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1300 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
