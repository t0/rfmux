...
| `pytest --tier=quick` | 1102 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1121 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
