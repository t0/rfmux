...
session browser. The tree's top level is **Pulses**, holding the channels
or the events as Group by says, then the Tuning, Time-ordered data and
Metadata items. After `rfmux periscope --install-desktop` (Linux and
