...
| `pytest --tier=quick` | 834 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 854 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
