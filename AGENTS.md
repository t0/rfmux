...
```bash
pytest --tier=quick                 # Edit loop: 1735 tests, ~7 min
pytest --tier=portable              # No CRS, no GUI: 662 tests, ~9 s
pytest --tier=full                  # All 1771 that run without a board, including demos
