...
| `pytest --tier=quick` | 1272 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1295 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
