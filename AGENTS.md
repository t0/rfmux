...
```bash
pytest --tier=quick                 # Edit loop: 1477 tests, ~3.5 min
pytest --tier=portable              # No CRS, no GUI: 631 tests, ~9 s
pytest --tier=full                  # All 1512 that run without a board, ~4 min
