...
| `pytest --tier=quick` | 1274 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1297 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
