...
| `pytest --tier=quick` | 1958 | varies | Default while editing. |
...
| `pytest --tier=full` | 1995 | varies | Before pushing. Everything that runs without a board, the acquisition tier included. |
| `pytest --tier=hardware --serial 0024` | 75 | needs a board | Against a connected board; see *Hardware tests*. |
| `pytest --tier=all --serial 0024` | 2070 | needs a board | Before a release. |
