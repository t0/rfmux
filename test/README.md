...
| `pytest --tier=quick` | 1282 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1305 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
