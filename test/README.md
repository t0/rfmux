...
| `pytest --tier=quick` | 844 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 864 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
