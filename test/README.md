...
| `pytest --tier=quick` | 1057 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1076 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
