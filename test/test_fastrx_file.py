...
def record(channels: int, seq: int, *, snapshot=None, serial=42) -> bytes:
    ...
    shape.  A pipe the layout needs but absent from snapshot is zero-filled,
    as the writer does during a pipeline drop-out.
