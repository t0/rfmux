...
| `pytest --tier=quick` | 836 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 856 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
