...
```bash
pytest --tier=quick                 # Edit loop: 1649 tests, ~7 min
pytest --tier=portable              # No CRS, no GUI: 644 tests, ~9 s
pytest --tier=full                  # All 1685 that run without a board, including demos
