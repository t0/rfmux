...
MOCK_DEFAULTS: Dict[str, Any] = {
    ...
    "cache_freq_step": 10,         # Hz - frequency quantization step for cache key (10 Hz for high fidelity)
    "cache_amp_step": 1e-6,        # Amplitude quantization step (1e-6 for minimal structure)
