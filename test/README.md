...
| --- | --- | --- | --- |
| `pytest --tier=portable` | 837 | varies | Changing packaging, dependencies, or the Python floor. This is what `tox` runs on 3.10-3.12. |
| `pytest --tier=quick` | 2327 | varies | Default while editing. |
...
| `pytest --tier=full` | 2367 | varies | Before pushing. Everything that runs without a board, the acquisition tier included. |
