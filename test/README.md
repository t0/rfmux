...
| `pytest --tier=quick` | 1095 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1114 | ~3.5 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
