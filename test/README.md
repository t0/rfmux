...
| `pytest --tier=quick` | 853 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 873 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
