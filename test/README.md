...
| `pytest --tier=quick` | 855 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 875 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
