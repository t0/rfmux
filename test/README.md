...
| `pytest --tier=quick` | 1281 | ~2 min | Default while editing. |
...
| `pytest --tier=full` | 1304 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
