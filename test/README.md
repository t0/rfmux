...
| `pytest --tier=quick` | 852 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 872 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
