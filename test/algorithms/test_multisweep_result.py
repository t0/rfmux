...
pytestmark = pytest.mark.skip(reason="pins main's multisweep contract (is_bifurcated, bias_frequency and a rotation on every entry, positional arguments); this branch's multisweep is measurement-only and catalog-driven, so the contract does not apply. See main_merge_conflict_survey.md §4.2.")
