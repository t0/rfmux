...
class DetectorDigestPanel(QtWidgets.QWidget, ScreenshotMixin):
    ...
    def _setup_ui(self):
        ...
        # Direct layout on self (QWidget base, no central widget)
    ...
    def _build_digest_tab(self):
        ...
        # Note: apply_theme() is called after both tabs are built in _setup_ui()
    ...
    def _build_noise_tab(self):
        ...
        self.noise_placeholder_label = QtWidgets.QLabel("Data only populated if 'Get Noise Spectrum' has been run from the multisweep panel")
    ...
    def apply_theme(self, dark_mode: bool):
        ...
        # Update digest tab background
        if hasattr(self, 'digest_page'):
            self.digest_page.setStyleSheet(f"QWidget {{ background-color: {bg_color_hex}; }}")
        
        # Update noise tab background
        if hasattr(self, 'noise_tab'):
            self.noise_tab.setStyleSheet(f"QWidget {{ background-color: {bg_color_hex}; }}")
