...
| `pytest --tier=quick` | 1015 | ~1 min | Default while editing. |
...
| `pytest --tier=full` | 1037 | ~4 min | Before pushing. Everything that runs without a board, the acquisition tier included. |
| `pytest --tier=hardware --serial 0024` | 75 | needs a board | Against a connected board; see *Hardware tests*. |
| `pytest --tier=all --serial 0024` | 1112 | needs a board | Before a release. |
